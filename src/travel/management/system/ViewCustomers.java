...
public class ViewCustomers extends JFrame {
	...
	public ViewCustomers() throws SQLException {
		...
		contentPane.setLayout(null);
                ...
                Image i3 = i1.getImage().getScaledInstance(590, 201,Image.SCALE_DEFAULT);
                ImageIcon i2 = new ImageIcon(i3);
                JLabel l1 = new JLabel(i2);
                l1.setBounds(-25,450,626,201);
                add(l1);
                
                ImageIcon i4  = new ImageIcon(ClassLoader.getSystemResource("travel/management/system/icons/viewall.jpg"));
                Image i5 = i4.getImage().getScaledInstance(590, 201,Image.SCALE_DEFAULT);
                ImageIcon i6 = new ImageIcon(i5);
                JLabel l2 = new JLabel(i6);
                l2.setBounds(540,450,626,201);
                add(l2);
		...
		btnNewButton.setBounds(390, 420, 120, 30);
